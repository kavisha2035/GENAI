            ...
            <div className="terms-checkbox-group">
              <label className="checkbox-container">
                ...
                <span className="checkbox-text">
                  I have read and agree to Kickresume's <a href="#" onClick={(e) => e.preventDefault()}>Terms of Use</a>, <a href="#" onClick={(e) => e.preventDefault()}>Privacy Policy</a> and <a href="#" onClick={(e) => e.preventDefault()}>Cookie Policy</a>.
                </span>
              </label>
            </div>
